...
class MSAPMListViewController: MSBaseViewController {
    ...
    lazy var tableView: UITableView = {
        ...
        tb.register(MSAPMTableViewCell.classForCoder(), forCellReuseIdentifier: TableViewCellIdentifier)
         tb.register(UITableViewCell.classForCoder(), forCellReuseIdentifier: sandboxTableViewCellIdentifier)
